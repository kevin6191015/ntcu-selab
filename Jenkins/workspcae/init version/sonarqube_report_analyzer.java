...
{
     public static String[] sonar_property=new String[14];
     public static String[] sonar_value=new String[14];
     public static String postparm="";
     ...
     public static void main(String[] args)throws Exception{
          ...
          GetSonarData(args[0]);
          GetJenkinsData(args[0],args[1],args[2]);
          GetPostparm();
          WriteData();
     }
     public static void  GetJenkinsData(String name,String submit_time,String unit_test_result){
     ...
     public static void  GetPostparm(){
     ...
     public static void parseData(StringBuilder response) {
          ...
          for (int i = 0; i < arr.length(); i++)
          {
               ...
               if(sonar_property[i].equals("bugs")){
                    sonar_property[i]="bugs_number";
               }else if(sonar_property[i].equals("vulnerabilities")){
                    sonar_property[i]="vulnerabilities_number";
               }else if(sonar_property[i].equals("code_smells")){
                    sonar_property[i]="code_smells_number";
               }
          }
          for(int i =0; i<11;i++){
